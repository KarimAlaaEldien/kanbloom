      ...
      <header className="border-b border-neutral-200/50 dark:border-neutral-800/80 bg-white/70 backdrop-blur-md dark:bg-neutral-900/60 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs font-semibold text-bloom-green px-2.5 py-1 rounded-full bg-bloom-green/10">
              <LayoutDashboard className="w-3.5 h-3.5" />
              <span>Gardener's Workspace</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="hidden md:flex flex-col text-left">
                ...
                <span className="text-[10px] text-text-secondary dark:text-neutral-400 mt-0.5 max-w-[120px] truncate">
                  {user.email}
                </span>
              </div>
            </button>
